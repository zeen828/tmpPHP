<?php
/*
 * Match only routes registered under this version.
 */
$version = env('API_VERSION', 'v1');

/*
 * Match only routes for method POST, PUT, PATCH.
 * 
...
$applicationRoutes = [
    'auth.token.*',
    'auth.client.build',
    'auth.client.rewrite.ban',
    'auth.client.disable',
    'auth.client.enable',
    'auth.client.rename',
    'auth.client.reset.secret',
    'auth.user.login',
    'auth.user.logout',
    'auth.user.signature',
    'auth.user.signature.login',
    'system.parameter.rewrite.value',
    'system.authority.global',
    'system.authority.grant',
    'system.authority.remove',
    'system.authority.snapshot.build',
    'system.authority.snapshot.rename',
    'notice.bulletin.build',
    'notice.bulletin.disable',
    'notice.bulletin.enable',
    // You can add routes for method POST, PUT, PATCH
    'admin.auth.change.password',
    'admin.auth.edit.profile',
    'admin.user.logon',
    'admin.user.resend.auth',
    'admin.user.index',
    'admin.user.disable',
    'admin.user.enable',
    'member.terms.touch',
    ...
    'member.auth.change.pin',
    'member.auth.edit.profile',
    'member.auth.edit.setting',
    'member.auth.logon',
    'member.auth.phone.login',
    'member.auth.verifycode',
    'member.user.disable',
    'member.user.enable',
    'business.auth.link',
    'business.invite.link',
    'business.invite.auth',
    'exchange.billing.link',
    'exchange.manual.billing',
    'exchange.manual.payment',
    'exchange.manual.deposit',
    'exchange.manual.interrupt',
    'exchange.withdraw.deposit',
    'exchange.withdraw.remittance',
    'exchange.withdraw.finish',
    'exchange.withdraw.cancel',
];
...
return [
    ...
    'laravel' => [
         ...
         */
        'middleware' => [
            App\Http\Middleware\Apidoc\Watchdog::class,
        ],

        /*
         * Set the IP to restrict the whitelist array.
         * List IPs here or use empty array to mean all IPs.
         */
        'watchdog_whitelisted' => [
            '::1',
            '127.0.0.1',
            '211.20.117.250',
        ],
    ...
    'routes' => [
        ...
        /* API doc other for POST, PUT, PATCH (Content-Type : application/x-www-form-urlencoded) */
        [
            'match' => [
                'domains' => [
                    '*',
        ...
        /* API doc other for POST, PUT, PATCH (Content-Type : multipart/form-data) */
        [
            'match' => [
                'domains' => [
                    '*',
        ...
        [
            ...
            'exclude' => array_merge($applicationRoutes, $multipartRoutes),
            'apply' => [
                'headers' => [
                    'Accept' => 'application/json',
                    'Accept-Language' => 'zh-TW,zh-CN;q=0.8,zh-HK;q=0.5,en-US;q=0.3,en;q=0.2',
     ...
     */
    'logo' => resource_path('views') . '/api/doc/logo.png',
