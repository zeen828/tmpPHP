...
return [
    ...
    */
    ...
    'interface' => [
        ...
        'member.terms.touch' => 'Reset Member Terms Time',
        'member.auth.read' => 'Read Member Personal Info',
        'member.auth.agree' => 'Member Agree Service Terms',
        'member.auth.change.password' => 'Member Change Password',
        'member.auth.change.pin' => 'Member Change Pin Code',
        'member.auth.edit.profile' => 'Member Edit Profile',
        'member.auth.edit.setting' => 'Member Edit Setting',
        'member.auth.logon' => 'Member Logon',
        'member.auth.phone.login' => 'Member Use Phone Login',
        'member.auth.verifycode' => 'Member SMS Verifycode',
        'member.user.index' => 'Member User Index',
        'member.user.read' => 'Member User Info',
        'member.user.disable' => 'Disable Member Service',
        'member.user.enable' => 'Enable Member Service',
        ...
        'business.index' => 'Business Service Index',
        'business.auth.link' => 'Business Service Auth Link',
        'business.invite.link' => 'Business Service Invite Link',
        'business.invite.auth' => 'Business Service Invite Auth',
        'business.bet.profile' => 'Business Bet Service Auth Profile',
        'business.binary.profile' => 'Business Binary Service Auth Profile',
        'exchange.billing.types' => 'Exchange Billing Types',
        'exchange.billing.link' => 'Exchange Billing Auth Link',
        'exchange.manual.billing' => 'Request Manual Billing',
        'exchange.manual.payment' => 'Build Payment Receipt',
        'exchange.manual.deposit' => 'Deposit Finish',
        'exchange.manual.interrupt' => 'Interrupt Manual Billing Receipt',
        'exchange.withdraw.deposit' => 'Request Withdraw Deposit',
        'exchange.withdraw.remittance' => 'Build Remittance Receipt',
        'exchange.withdraw.finish' => 'Remittance Finish',
        'exchange.withdraw.cancel' => 'Cancel Withdraw Deposit Receipt',
    ]
];
