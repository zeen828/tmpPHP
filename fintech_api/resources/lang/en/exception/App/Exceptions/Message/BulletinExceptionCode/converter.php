    ...
    */
    ...
    'customize' => [
        500 => [
            ...
            ExceptionCode::NON_ANNOUNCEABLE_USER_TYPE => [
                'code' => (string) ExceptionCode::NON_ANNOUNCEABLE_USER_TYPE,
                'status' => '400',
                'message' => 'Non-announceable user types.'
            ],
            ExceptionCode::CREATE_FAIL => [
                'code' => (string) ExceptionCode::CREATE_FAIL,
                'status' => '507',
