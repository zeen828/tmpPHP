...
use App\Libraries\Upgrades\BetterApiDocPostmanCollectionWriter as PostmanCollectionWriter;

class BetterApiDocWriter extends Writer
{
    /**
     * @var Command
     */
    ...
    /**
     * Create postman void file for laravel
     * 
     * Append function
     * 
     * @return void
     */
    public function initPostmanFile(): void
    {
        $storageInstance = Storage::disk($this->config->get('storage'));
        $storageInstance->put('apidoc/collection.json', '{}');
    }
