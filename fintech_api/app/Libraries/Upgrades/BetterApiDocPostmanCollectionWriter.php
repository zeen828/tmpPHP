...
class BetterApiDocPostmanCollectionWriter extends PostmanCollectionWriter
{
    /**
     * @var Collection
     */
    ...
    protected function generateEndpointItem($route)
    {
        ...
        $urlencoded = collect($route['cleanBodyParameters'])->map(function ($value, $key) {
            // Postman var
            $value = strtr($value, ['{{' => '{' , '}}' => '}' ]);
            $value = strtr($value, ['{' => '{{' , '}' => '}}' ]);
            return [
        ...
        return [
            ...
            'request' => [
                ...
                'body' => [
                    'mode' => 'urlencoded', // Modified to urlencoded
                    'urlencoded' => $urlencoded, // Modified to urlencoded data
                ],
