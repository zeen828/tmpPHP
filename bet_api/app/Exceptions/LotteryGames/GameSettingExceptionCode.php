...
/**
 * Class GameSettingExceptionCode.
 *
 * @package App\Exceptions\LotteryGames
 */
class GameSettingExceptionCode extends ExceptionCodeBase
{
    ...
    const DEBUG_MESSAGE = [
      ...
      self::NOT_EXIST => 'Game lottery setting does not exist.',
    ];
    ...
    {
       return "App\\Exceptions\\LotteryGames\\GameSettingExceptionCode";
    }
}
