...
namespace App\Criteria\Receipt\Form;
 ...
 * Class IndexCriteria.
 *
 * @package namespace App\Criteria\Receipt\Form;
 */
class IndexCriteria implements CriteriaInterface
{
    ...
    public function apply($model, RepositoryInterface $repository)
    {
        ...
        /* Formdefine code query */
        $quest = $quest->where('formdefine_code', '=', $repository->questFormCode());
        /* Source */
