...
Route::group([
    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::patch('/{app_id}/reset_secret', 'Jwt\ClientController@resetSecret')->middleware(['request.client.appid'])->name('reset.secret')->where('app_id', '[1-9]{1}[0-9]*');
            ...
            Route::patch('/{app_id}/disable', 'Jwt\ClientController@disable')->middleware(['request.client.appid'])->name('disable')->where('app_id', '[1-9]{1}[0-9]*');
            /* Enable client service */
            Route::patch('/{app_id}/enable', 'Jwt\ClientController@enable')->middleware(['request.client.appid'])->name('enable')->where('app_id', '[1-9]{1}[0-9]*');
        });
    });
    /* System Base API */
    Route::group([
    ...
    Route::group([
        ...
        Route::group([
            ...
            /* Disable bulletin */
            Route::patch('/{id}/disable', 'Message\BulletinController@disable')->name('disable')->where('id', '[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}');
            /* Enable bulletin */
            Route::patch('/{id}/enable', 'Message\BulletinController@enable')->name('enable')->where('id', '[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}');
        });
        /* Get notice messages */
